...
const GET_BOND_INTERESTS_QUERY = `SELECT * FROM bond_interests ORDER BY id ASC`
const GET_EXPENDITURE_VALUES_QUERY = `SELECT * FROM expenditure_values ORDER BY id ASC`